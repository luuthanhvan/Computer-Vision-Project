...
def load_existing_images():
    base_path = '/home/ltvan/computer_vision_project/models/research/object_detection/test_images/'
    filenames = ['image1.jpg', 'image2.jpg']
    image_paths = []
...
def load_downloaded_model(model_name):
    base_path = '/home/ltvan/computer_vision_project/workspace/training_demo/pre-trained-models/'
...
def load_existing_labels(filename):
    base_path = '/home/ltvan/computer_vision_project/models/research/object_detection/data/'
