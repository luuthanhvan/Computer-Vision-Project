...
'''
RUNNING
  python exporter_main_v2.py --input_type image_tensor --pipeline_config_path models/my_ssd_mobilenet_v2_320x320/pipeline.config --trained_checkpoint_dir models/my_ssd_mobilenet_v2_320x320/ --output_directory exported-models/my_model/
'''
