...
'''
- REFERENCE: https://github.com/abdelrahman-gaber/tf2-object-detection-api-tutorial

- RUNNING: Copy one of commands below to execute this code. Note that, download pre-trained model before run this code.
	python detect_objects.py --model_path pre-trained-models/efficientdet_d0_coco17_tpu-32/saved_model --path_to_labelmap ../../models/research/object_detection/data/mscoco_label_map.pbtxt --images_dir ../../models/research/object_detection/test_images/
	python detect_objects.py --model_path pre-trained-models/ssd_mobilenet_v2_320x320_coco17_tpu-8/saved_model --path_to_labelmap ../../models/research/object_detection/data/mscoco_label_map.pbtxt --images_dir ../../models/research/object_detection/test_images/
'''
